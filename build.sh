...
cmake git libmaxminddb-dev libpcre2-dev libzstd-dev mercurial > /dev/null 2>&1
...
--without-http_browser_module --without-http_empty_gif_module --without-http_limit_conn_module \
--without-http_memcached_module --without-http_mirror_module \
--without-http_referer_module --without-http_split_clients_module \
--without-http_scgi_module --without-http_ssi_module --without-http_userid_module \
...
--with-zlib=modules/zlib --with-openssl=modules/openssl > /dev/null 2>&1
